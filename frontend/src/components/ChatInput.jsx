...
const ChatInput = ({ onFileUpload, onSendMessage, isLoading }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-[24px] p-4 shadow-2xl transition-all focus-within:border-white/10">
        <textarea 
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className="p-2 text-slate-400 hover:text-primary-400 hover:bg-white/5 rounded-full transition-all"
            >
